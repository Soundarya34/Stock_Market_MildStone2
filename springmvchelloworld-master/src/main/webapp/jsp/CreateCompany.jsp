		...
		<div class="body">
			...
			<div class="signup-form">
				<form:form method="get" action="registerCompany"
					...
					<div class="form-group">
						<label class="control-label col-xs-4">Board Of Directors</label>
						<div class="col-xs-8">
							<form:input type="text" class="form-control"
								path="boardOfDirectors" />
							<form:errors path="boardOfDirectors" cssClass="error" />
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-xs-4">Turnover</label>
						<div class="col-xs-8">
							<form:input type="number" class="form-control" path="turnover" />
							<form:errors path="turnover" cssClass="error" />
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-xs-4">Brief Writeup</label>
						<div class="col-xs-8">
							<form:input type="text" class="form-control" path="writeup" />
							<form:errors path="writeup" cssClass="error" />
						</div>
					</div>
